...
description: Create structured, language-agnostic implementation plans with risks, tests, and approvals. Use when the user asks for a plan or design before coding.
metadata:
...
4. Call out risks, alternatives, and decisions needed from the user.
5. Include a test/verification plan and note any docs to update.
